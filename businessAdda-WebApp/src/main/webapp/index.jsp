	...
	<body>
		<div id="main-div" style="width:auto;height:800px;border-radius: 5px;">
			<div id="top-div">
		  		...
		  		<div id="login-div" >
		  		<div style="float:left; margin-top: 4px;margin-right:55%"> </div>
		  			...
		  			<div style="float:right; margin-top: 4px;margin-right:10px;width:100px" style="width:10%"><img id="hideRegFormId" style="display:none;margin-left:10px; color: #FFCC99;font-weight:bold;text-decoration: none;cursor:pointer;" src="./images/rarrw.gif" onclick="javascript:toggleLoginForm();" />
		  		...
		  		<div align="center" id="bottom-div" style="width:80%" >
		  			<div style="float:right;width:80%;border-radius: 10px; background:#FFFFFF">
		  				<br/><br/>
